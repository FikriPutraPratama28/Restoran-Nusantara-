...
<div x-data x-cloak>
    ...
    >
        ...
        >
            <div class="w-20 h-20 bg-gray-100 dark:bg-dark-700 rounded-3xl flex items-center justify-center">
            ...
            <p class="text-gray-500 dark:text-gray-400 text-sm">Tambahkan menu favoritmu terlebih dahulu.</p>
            <button
                @click="$store.cart.close()"
